...
void eliminarDatos()
{
    ...
    if (obtPos(id) == -1)
    {
        cout << "No se encontró registro" << endl;
        return;
    }
    eliminar(id);
...
void showData(PERSONAS &c)
{
    ...
    cout << "Día: " << c.dia << endl;
    cout << "Mes: " << c.mes << endl;
    cout << "Año: " << c.anio << endl;
    cout << endl;
    cout << "La cédula del paciente es: " << c.cedula << endl;
    cout << "El género del paciente es: " << c.genero << endl;
    if (c.generoSec != '\0')
    {
        cout << "El género secundario del paciente es: " << c.generoSec << endl;
    }
    else
    {
        cout << "No se ha agregado género secundario..." << endl;
    }
    cout << "La ciudad de residencia del paciente es: " << c.ciudad << endl;
    cout << "La dirección del hogar del paciente es: " << c.direccion << endl;
    cout << "El teléfono celular del paciente es: " << c.telefono << endl;
    cout << "El correo electrónico del paciente es: " << c.correo << endl;
    cout << "La relación civil del paciente actualmente es: " << c.relacion << endl;
    cout << "=====================================================================" << endl;
}
...
void pedirDatos()
{
    ...
    cout << "Escriba la relación que tiene el paciente actualmente: " << endl;
    cout << "1. Casado" << endl;
    cout << "2. Soltero" << endl;
...
void editarDatos()
{
    ...
    showData(c);
    cout << endl;
    // Menú para editar los datos
    cout << "¿Qué dato desea editar?" << endl;
    cout << "1. Nombre" << endl;
    cout << "2. Apellido" << endl;
    cout << "3. Edad" << endl;
    cout << "4. Día del nacimiento" << endl;
    cout << "5. Mes del nacimiento" << endl;
    cout << "6. Año del nacimiento" << endl;
    cout << "7. Cédula" << endl;
    cout << "8. Género" << endl;
    cout << "9. Género Secundario" << endl;
    cout << "10. Ciudad" << endl;
    cout << "11. Dirección" << endl;
    cout << "12. Teléfono" << endl;
    cout << "13. Correo" << endl;
    cout << "14. Relación del paciente" << endl;
...
// Guardar todos los pacientes en el archivo (para el proceso de edición)
void saveAll()
{
...
{
    int opc;
    cout << "Bienvenido al sistema de pacientes" << endl;
